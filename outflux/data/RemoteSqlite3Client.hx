/**
   Author: Ritchie Turner, outflux.cl
   Licence: 
**/
...
private class BucketProxy extends haxe.remoting.AsyncProxy<outflux.data.RemoteBucketProxy> { }
private class HashProxy extends haxe.remoting.AsyncProxy<outflux.data.RemoteHashProxy> { }
