...
class Flow {
  ...
  sink():Sink {
    return new outflux.channel.ServerSinkImpl();
  }

  public static function
  pushConduit(sessionMgr:SessionMgr):Conduit {
    var pl = new outflux.channel.PushListenerImpl(sessionMgr);
  ...
  public static function
  pushConduit():Conduit {
    return new outflux.channel.PushClientImpl();
  }

  public static function
  sink():Sink {
    return new outflux.channel.ClientSinkImpl();
  }
