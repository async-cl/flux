...
Client.sortByIndex = function(a,b) {
	return Std.parseInt(a.index) - Std.parseInt(b.index);
}
...
flux.Future = function() { }
$hxClasses["flux.Future"] = flux.Future;
...
flux.Startable = function() { }
$hxClasses["flux.Startable"] = flux.Startable;
flux.Startable.__name__ = ["flux","Startable"];
flux.Startable.prototype = {
	start_: null
	,__class__: flux.Startable
}
flux.Stoppable = function() { }
$hxClasses["flux.Stoppable"] = flux.Stoppable;
flux.Stoppable.__name__ = ["flux","Stoppable"];
flux.Stoppable.prototype = {
	stop_: null
	,__class__: flux.Stoppable
}
flux.Infoable = function() { }
$hxClasses["flux.Infoable"] = flux.Infoable;
...
flux.Observable = function() { }
$hxClasses["flux.Observable"] = flux.Observable;
...
flux.ObservableDelegate = function() { }
$hxClasses["flux.ObservableDelegate"] = flux.ObservableDelegate;
...
flux.ObservableDelegateX = function() { }
$hxClasses["flux.ObservableDelegateX"] = flux.ObservableDelegateX;
...
flux.Core = function() { }
$hxClasses["flux.Core"] = flux.Core;
flux.Core.__name__ = ["flux","Core"];
flux.Core.startableAspect = null;
flux.Core.stoppableAspect = null;
...
flux.StartableX.start = function(s,p,oc) {
	...
	if(flux.Core.startableAspect != null) {
		var foc = new flux.core.FutureImpl();
		foc.deliver(function(o) {
			flux.Core.startableAspect(s,o);
			oc.resolve(o);
		});
		s.start_(p,foc);
		return oc;
...
flux.StoppableX = function() { }
$hxClasses["flux.StoppableX"] = flux.StoppableX;
flux.StoppableX.__name__ = ["flux","StoppableX"];
flux.StoppableX.stop = function(s,p,oc) {
	if(oc == null) oc = new flux.core.FutureImpl();
	if(flux.Core.stoppableAspect != null) {
		var foc = new flux.core.FutureImpl();
		foc.deliver(function(o) {
			flux.Core.stoppableAspect(s,o);
			oc.resolve(o);
		});
		s.stop_(p,foc);
		return oc;
...
flux.DynamicX = function() { }
$hxClasses["flux.DynamicX"] = flux.DynamicX;
...
flux.FloatX = function() { }
$hxClasses["flux.FloatX"] = flux.FloatX;
...
flux.StringX = function() { }
$hxClasses["flux.StringX"] = flux.StringX;
...
flux.DateX = function() { }
$hxClasses["flux.DateX"] = flux.DateX;
...
flux.ArrayX = function() { }
$hxClasses["flux.ArrayX"] = flux.ArrayX;
...
flux.HashX = function() { }
$hxClasses["flux.HashX"] = flux.HashX;
...
flux.OptionX = function() { }
$hxClasses["flux.OptionX"] = flux.OptionX;
...
flux.EitherX = function() { }
$hxClasses["flux.EitherX"] = flux.EitherX;
...
flux.OutcomeX = function() { }
$hxClasses["flux.OutcomeX"] = flux.OutcomeX;
...
$hxClasses["flux.core.FutureImpl"] = flux.core.FutureImpl;
...
flux.core.LogImpl = function() { }
$hxClasses["flux.core.LogImpl"] = flux.core.LogImpl;
...
flux.core.ObservableImpl = function() {
	this._observers = [];
	this._unsubscribes = 0;
};
$hxClasses["flux.core.ObservableImpl"] = flux.core.ObservableImpl;
